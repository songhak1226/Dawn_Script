...
public class Arrow : XRGrabInteractable
{
    ...
    [SerializeField] ParticleSystem hitParticlePrefab1;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.SendMessage("OnHitArrow");   // 충돌 대상에 "OnHitBullet" 메시지
            audioSource.Play();
        ...
        {
            audioSource.Play();
            Instantiate(hitParticlePrefab1, transform.position, transform.rotation); // 총알 적중 지점에 연츨
        }
